 ...
 */
@Entity
@Table(name = "recruitment", catalog = "mlnx")
public class Recruitment implements java.io.Serializable {
	...
	/** full constructor */
	public Recruitment(String recruitPost, String recruitDuty,
			String recruitClaim, Timestamp recruitTime, Integer recruitStatus) {
