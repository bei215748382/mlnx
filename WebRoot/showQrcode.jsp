          ...
          <div class="box span10">
            ...
            <div class="box-content">
              <table
                ...
                <thead>
                  <tr>
                    <th class="span2">二维码图片</th>
                    <th class="span3">二维码名称</th>
                    <th class="span2">二维码尺寸</th>
                ...
                <tbody>
                  <c:forEach items="${qrcodes }" var="qr">
                    <tr>
                      ...
                      <td class="center" id="qrPosition${qr.qid }">${qr.qrPosition
                        }</td>
                      <td class="center"><c:if
                          test="${qr.qrStatus==0 }">
                          <a class="btn btn-success"
                            href="admin!changeQrcode.action?status4=0&currId4=${qr.qid }">
                            <i class="icon-ok icon-white"></i> 启用
                          </a>
                        </c:if> <c:if test="${qr.qrStatus==1 }">
                          <a class="btn btn-warning"
                            href="admin!changeQrcode.action?status4=1&currId4=${qr.qid }">
                            <i class="icon-remove icon-white"></i> 禁用
                          </a>
                        </c:if> <span id="modiQr${qr.qid }"> <a
                          class="btn btn-info" style="cursor: pointer;"
                          onclick="modiQrcode(${qr.qid })"> <i
                            class="icon-edit icon-white"></i> 修改
                        </a>
                      </span> <a class="btn btn-danger"
                        style="cursor: pointer;"
                        onclick="deleQrcode(${qr.qid })"> <i
            ...
            <div align="right">
              <a href="addQrcode.jsp"><button type="button"
