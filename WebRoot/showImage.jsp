              ...
              <table
                ...
                <thead>
                  <tr>
                    ...
                    <th class="span1">尺寸</th>
                    <th class="span3">图片描述</th>
                    <th class="span2">图片类型</th>
                ...
                <tbody>
                  <c:forEach items="${images }" var="img">
                    <tr>
                      ...
                      <td class="center" id="imgType${img.iid }">${img.imgType
                        }</td>
                      <td class="center" id="imgPosition${img.iid }">${img.imgPosition
                        }</td>
                      <td class="center"><c:if
                          test="${img.imgStatus==0 }">
                          <a class="btn btn-success"
                            href="admin!changeImage.action?status11=0&currId11=${img.iid }">
                            <i class="icon-ok icon-white"></i> 启用
                          </a>
                        </c:if> <c:if test="${img.imgStatus==1 }">
                          <a class="btn btn-warning"
                            href="admin!changeImage.action?status11=1&currId11=${img.iid }">
                            <i class="icon-remove icon-white"></i> 禁用
                          </a>
                        </c:if> <span id="modiImg${img.iid }"> <a
                          class="btn btn-info" style="cursor: pointer;"
                          onclick="modiImage(${img.iid })"> <i
                            class="icon-edit icon-white"></i> 修改
                        </a>
                      </span> <a class="btn btn-danger"
                        style="cursor: pointer;"
                        onclick="deleImage(${img.iid })"> <i
