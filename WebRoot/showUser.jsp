                    ...
                    <tr>
                      ...
                      <td class="center"><c:if
                          ...
                          <a class="btn btn-success"
                            href="admin!changeUser.action?status12=0&currId12=${ur.uid }">
                            <i class="icon-ok icon-white"></i> 解封
                          </a>
                        </c:if> <c:if test="${ur.ustatus==1 }">
                          <a class="btn btn-warning"
                            href="admin!changeUser.action?status12=1&currId12=${ur.uid }">
                            <i class="icon-remove icon-white"></i> 停封
                          </a>
                        </c:if></td>
                    </tr>
                  </c:forEach>
