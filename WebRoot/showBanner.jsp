      ...
      <div class="row">
        ...
        <div class="span10">
          <div class="box span10">
                    ...
                    <tr>
                      ...
                      <td class="center"><c:if
                          ...
                          <a class="btn btn-success"
                            href="admin!changeBanner.action?status3=0&currId3=${ban.bid }">
                            <i class="icon-ok icon-white"></i> 启用
                          </a>
                        </c:if> <c:if test="${ban.banStatus==1 }">
            ...
            <div align="right">
              <a href="addBanner.jsp"><button type="button"
