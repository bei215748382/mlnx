      ...
      <div class="row">
        ...
        <div class="span10">
          <div class="box span10">
                ...
                <tbody>
                  <c:forEach items="${products }" var="prod">
                    <tr>
                      ...
                      <td class="center" id="pduDetail${prod.pid }">${prod.pduDetail
                        }</td>
                      <td class="center" id="pduPriority${prod.pid }">${prod.pduPriority
                        }</td>
                      <td class="center"><c:if
                          test="${prod.pduStatus==0 }">
                          <a class="btn btn-success"
                            href="admin!changeProduct.action?status8=0&currId8=${prod.pid }">
                            <i class="icon-ok icon-white"></i> 启用
                          </a>
                        </c:if> <c:if test="${prod.pduStatus==1 }">
                          <a class="btn btn-warning"
                            href="admin!changeProduct.action?status8=1&currId8=${prod.pid }">
                            <i class="icon-remove icon-white"></i> 禁用
                          </a>
                        </c:if> <span id="modiPdu${prod.pid }"> <a
                          class="btn btn-info" style="cursor: pointer;"
                          onclick="modiProduct(${prod.pid })"> <i
                            class="icon-edit icon-white"></i> 修改
                        </a>
                      </span> <a class="btn btn-danger"
                        style="cursor: pointer;"
                        onclick="deleProduct(${prod.pid })"> <i
            ...
            <div align="right">
              <a href="addProduct.jsp"><button type="button"
