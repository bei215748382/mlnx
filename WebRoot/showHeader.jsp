      ...
      <div class="row">
        ...
        <div class="span10">
          <div class="box span10">
                  ...
                  <c:forEach items="${headers }" var="head">
                    <tr>
                      ...
                      <td class="center"><c:if
                          test="${head.headerStatus==0 }">
                          <a class="btn btn-success"
                            href="admin!changeHeader.action?status1=0&currId1=${head.hid }">
                            <i class="icon-ok icon-white"></i> 启用
                          </a>
                        </c:if> <c:if test="${head.headerStatus==1 }">
                          <a class="btn btn-warning"
                            href="admin!changeHeader.action?status1=1&currId1=${head.hid }">
                            <i class="icon-remove icon-white"></i> 禁用
                          </a>
                        </c:if> <a class="btn btn-danger"
                        style="cursor: pointer;"
                        onclick="deleHeader(${head.hid })"> <i
            ...
            <div align="right">
              <a href="addHeader.jsp"><button type="button"
